...
{ 
        ...
        switch(count) {
            ...
            case 4:
                ...
                if(masterTest.equals(masterCode)) {
                    ...
                    JOptionPane.showMessageDialog(null, "Your Password is Wrong. Try Again!");
                }
    ...
    private void Button1MouseReleased(java.awt.event.MouseEvent evt) {                                      
        buttonClick=1;
        circleControl();
    }                                     
    ...
    private void Button3MouseReleased(java.awt.event.MouseEvent evt) {                                      
        buttonClick=3;
        circleControl();
    }                                     
    ...
    private void Button5MouseReleased(java.awt.event.MouseEvent evt) {                                      
        buttonClick=5;
        circleControl();
    }                                     

    private void Button6MouseReleased(java.awt.event.MouseEvent evt) {                                      
        buttonClick=6;
        circleControl();
    }                                     

    private void Button7MouseReleased(java.awt.event.MouseEvent evt) {                                      
        buttonClick=7;
        circleControl();
    }                                     

    private void Button8MouseReleased(java.awt.event.MouseEvent evt) {                                      
        buttonClick=8;
        circleControl();
    }                                     

    private void Button9MouseReleased(java.awt.event.MouseEvent evt) {                                      
        buttonClick=9;
        circleControl();
    }                                     

    private void Button0MouseReleased(java.awt.event.MouseEvent evt) {                                      
        buttonClick=0;
        circleControl();
    }                                     
